# Python for Tidy R Users: A Research Analyst's Guide

Welcome to the Python tutorial for R Enthusiasts. This guide is designed specifically for research analysts who are comfortable with the "Tidyverse" workflow and want to translate those skills into the Python ecosystem.

## Introduction
The goal of this tutorial series is to provide a "Rosetta Stone" between R and Python, focusing on data science, statistical modeling, and visualization.
...
## 2. The Data Wrangling "Rosetta Stone"
*   **[Lesson 03: Dplyr to Pandas/Polars](tutorials/02_wrangling/01_rosetta_stone.md)**
*   **[Lesson 04: Date & Time Manipulation](tutorials/02_wrangling/02_datetime.md)**

## 3. Data Visualization
*   **[Lesson 05: Static Plots (Plotnine, Seaborn)](tutorials/03_visualization/01_static_plots.md)**

## 4. Statistical Modeling
*   **[Lesson 06: Regression Models (Statsmodels, Sklearn)](tutorials/04_statistics/01_regression_models.md)**

## 5. Interactive Displays
*   **[Lesson 07: Interactive Visuals with Plotly](tutorials/05_interactive/01_plotly_basics.md)**
...
4. **Lesson 04:** Date & Time Manipulation.
5. **Lesson 05:** Visualizing Data (From ggplot2 to Plotnine & Seaborn).
